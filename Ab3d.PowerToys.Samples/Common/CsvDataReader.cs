// ----------------------------------------------------------------
// <copyright file="CsvDataReader.cs" company="AB4D d.o.o.">
...
namespace Ab3d.PowerToys.Samples.Common
{
    ...
    public class CsvDataReader
    {
        ...
        public float[] GetValues(string columnName)
        {
            ...
            return GetValues(columnName, out minValue, out maxValue);
        }
        ...
        {
            float minValue, maxValue;
            return GetValues(columnName, startIndex, valuesCount, out minValue, out maxValue);
        }
        ...
        public Point3D[] GetPositions(out Rect3D bounds)
        {
        ...
        public Point3D[] GetPositions(int startIndex, int positionsCount, out Rect3D bounds)
        {
            ...
            for (int i = startIndex + 1; i < endPositionIndex; i++)
            {
                ...
                positions[positionsIndex] = new Point3D(x, y, z);
                positionsIndex++;
